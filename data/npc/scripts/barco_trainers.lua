...
gengia = false                                            ---->TRUE:Working/FALSE:Not Working<---- 
---------------------------------------END GENGIA CONFIG------------------------------------------
...
Venore = false                                          ----> TRUE:Working/FALSE:Not Working<--- 
---------------------------------------END VENORE CONFIG------------------------------------------ 
...
---Trainer Island----------------------------------------------------------------------------------------------------------------------------------------- 
local TrainerzText = 'You sure look weak. So you want to go to Trainers eh? I can take you there for 0 gold coins.' 
local TrainerzTextNo = 'Next time bring some blunts at least.' 
local NoTravel = 'Sorry, i do not travel to this city..' 
local TrainerzCost = 10 
local TrainerzPremium = true --True/false 

--Trainer Island-- 
if Trainerz == true then 
local travelNode = keywordHandler:addKeyword({'trainers'},  
...
travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = TrainerzTextNo }) 
else 
local travelNode = keywordHandler:addKeyword({'trainers'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = NoTravel }) 
end 
--End Trainer Island-- 
